    ...
    <SafeAreaView style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.infoBox}>
          <Ionicons name="information-circle" size={20} color="#B8891A" />
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 18, fontWeight: '700', color: '#2b0a59' },
  ...
  summaryLabel: { fontSize: 13, color: '#6B6050', fontWeight: '500' },
  summaryValue: { fontSize: 14, fontWeight: '700', color: '#1A1508' },

  methodsContainer: { marginBottom: 24 },
  methodsTitle: { fontSize: 16, fontWeight: '700', color: '#1A1508', marginBottom: 14 },
  ...
  methodName: { fontSize: 15, fontWeight: '700', color: '#1A1508' },
  badge: {
  ...
  methodDescription: { fontSize: 12, color: '#6B6050' },
  ...
  infoText: { fontSize: 12, color: '#6B6050', flex: 1, lineHeight: 16 },
  ...
  securityText: { fontSize: 12, color: '#10B981', marginLeft: 8, fontWeight: '500' },
