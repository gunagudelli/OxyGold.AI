...
const PgPaymentHandlerScreen = ({ navigation, route }) => {
  ...
  const startCashfreePayment = () => {
    try {
      ...
      // ✅ Try SANDBOX first (web uses sandbox mode)
      let session = new CFSession(
        paymentSessionId,
        cashfreeOrderId,
        CFEnvironment.SANDBOX, // Match web app
      );
        ...
        <View style={styles.centerContainer}>
          ...
          >
            ...
            <View style={styles.spinnerInner}>
              <Ionicons name="card" size={32} color="#B8891A" />
            </View>
          </Animated.View>
...
const styles = StyleSheet.create({
  ...
  spinnerArc: {
    ...
    borderTopColor: "#B8891A",
    borderRightColor: "rgba(184,137,26,0.3)",
  },
  spinnerInner: {
    width: 80,
    height: 80,
  ...
  infoLabel: { fontSize: 13, color: "rgba(255,255,255,0.6)" },
