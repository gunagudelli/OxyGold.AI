...
const PaymentScreen = ({ navigation, route }) => {
  ...
  const paymentMethods = [
    { id: 'upi', name: 'UPI Payment', icon: 'phone-portrait-outline', color: '#4F46E5' },
    { id: 'card', name: 'Debit/Credit Card', icon: 'card-outline', color: '#059669' },
    { id: 'netbanking', name: 'Net Banking', icon: 'business-outline', color: '#DC2626' },
    { id: 'wallet', name: 'Digital Wallet', icon: 'wallet-outline', color: '#7C3AED' },
  ];
      ...
      <View style={styles.content}>
        ...
        <View style={styles.summarySection}>
          ...
          <View style={styles.summaryRow}>
            ...
            <Text style={styles.summaryValue}>₹{goldValue?.toLocaleString()}</Text>
          </View>
      ...
      <View style={styles.buttonContainer}>
        ...
        >
          {payLoading ? (
            ...
            <Text style={styles.buttonText}>Pay ₹{totalAmount?.toLocaleString()}</Text>
          )}
        </TouchableOpacity>
      </View>
    </SafeAreaView>
