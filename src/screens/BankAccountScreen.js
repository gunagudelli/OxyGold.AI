...
const BankAccountScreen = ({ navigation, route }) => {
  ...
  const handleSubmit = async () => {
    ...
    if (accountNumber.length < 9 || accountNumber.length > 18) {
      console.log('[BankAccountScreen] Validation failed: account number length');
    ...
    try {
      ...
      console.log('[BankAccountScreen] ========== SAVE BANK DETAILS START ==========');
      console.log('[BankAccountScreen] Payload:', JSON.stringify(payload, null, 2));
      console.log('[BankAccountScreen] Calling: POST ${BASE_URL}/auth/saveBankDetails');
      
      const response = await apiPost(`${BASE_URL}/auth/saveBankDetails`, payload);
      
      console.log('[BankAccountScreen] ========== API RESPONSE ==========');
      console.log('[BankAccountScreen] Response:', JSON.stringify(response, null, 2));
      ...
      console.log('[BankAccountScreen] ========== SAVE BANK DETAILS SUCCESS ==========');
      ...
      console.log('[BankAccountScreen] Error Data:', JSON.stringify(error.data, null, 2));
    ...
    <SafeAreaView style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.infoStrip}>
          ...
          <Text style={styles.infoText}>Funds credited within T+1 working day</Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.fieldGroup}>
            ...
            <View style={styles.inputWrapper}>
              <Ionicons name="card-outline" size={18} color="#464B8B" style={styles.icon} />
              <TextInput
                style={styles.input}
          ...
          <View style={[styles.fieldGroup, { marginBottom: 0 }]}>
            ...
            <View style={styles.inputWrapper}>
              <Ionicons name="code-slash-outline" size={18} color="#464B8B" style={styles.icon} />
              <TextInput
                style={styles.input}
...
const styles = StyleSheet.create({
  ...
  infoStrip: {
    ...
    marginBottom: 16, borderWidth: 1, borderColor: 'rgba(22,163,74,0.2)',
  },
  infoText: { fontSize: 12, color: '#16a34a', fontWeight: '600', flex: 1 },
  card: {
    backgroundColor: '#fff', borderRadius: 14, padding: 16,
    marginBottom: 20, borderWidth: 1, borderColor: '#E8E3D8',
  },
  fieldGroup: { marginBottom: 16 },
  label: { fontSize: 12, fontWeight: '700', color: '#464B8B', marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 },
  inputWrapper: {
  ...
  btn: {
    backgroundColor: '#464B8B', borderRadius: 12,
