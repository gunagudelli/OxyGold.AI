  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      await AsyncStorage.setItem('user', JSON.stringify({
        phone, isLoggedIn: true, token, role: SELECTED_ROLE,
      }));
                ...
                <View style={styles.leftContent}>
                  ...
                  <View>
                    ...
                    <Text style={styles.leftDesc}>
                      Join thousands of smart investors building wealth with digital gold — secure, insured, and always live rates.
                    </Text>
              ...
              <Animated.View style={anim}>
                ...
                {step === 'phone' ? (
                  <>
                    ...
                    <Text style={styles.formSub}>Enter your mobile to get started</Text>
                  ...
                  <>
                    ...
                    <TouchableOpacity
                      ...
                      {loading
                        ? <ActivityIndicator color={C.navy} size="small" />
                        : <Text style={styles.btnText}>{showSuccess ? 'Success!' : 'Verify & Continue  →'}</Text>}
                    </TouchableOpacity>
                  </>
                )}
