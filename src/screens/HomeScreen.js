...
// ── Assets ────────────────────────────────────────────────────────────────────
const HERO_IMAGE =
  "https://assets.gadgets360cdn.com/img/gold/digital-gold-og-image.png";
const ABOUT_IMAGE =
  "https://d1fow5xdcuw86u.cloudfront.net/assets/blog/Digital_Gold_A_071020251243279663034.webp";
...
const TESTIMONIALS = [
  {
    q: "Started with ₹500 and now have a solid gold portfolio. Purity guarantee and instant sell are unmatched.",
    nm: "Hari Babu",
    ct: "Mumbai",
    av: "H",
  },
  {
    q: "KYC took 90 seconds and I bought my first gram the same evening. Seamless experience.",
    nm: "Rahul Verma",
    ct: "Bangalore",
    av: "R",
  },
  {
    q: "Feels premium. Live price tracker and same-day withdrawal make it a no-brainer.",
    nm: "Ananya Patel",
    ct: "Hyderabad",
    av: "A",
  },
  ...
  return (
    <Animated.View
      style={[
        ...
        {
          opacity: fadeIn,
          transform: [{ scale: scaleIn }, { translateY: floatY }],
        },
      ]}
    >
  ...
  return (
    <Animated.View
      style={[
        ...
        {
          opacity: fadeIn,
          transform: [{ translateX: slideX }, { scale: scaleIn }],
        },
      ]}
    >
      ...
      <ScrollView showsVerticalScrollIndicator={false} bounces={false}>
        ...
        >
          ...
          <Text style={s.heroDesc}>
            Real 24K gold, stored in insured vaults. Buy, track and sell from
            your phone — no storage hassle, no making charges.
          </Text>
          ...
          <View style={s.ticker}>
            ...
            <View style={s.tickerCell}>
              ...
              {lastUpdated && (
                <Text style={s.tickerUpdated}>{lastUpdated}</Text>
              )}
            </View>
          </View>
        ...
        <LinearGradient colors={["#162d57", "#112347"]} style={s.section}>
          ...
          <Text style={s.sTitle}>
            What is <Text style={s.sGold}>Digital Gold?</Text>
          </Text>
          ...
          <Text style={s.sDesc}>
            Buy real 24K gold online — no physical storage needed. Your gold is
            held in insured, BIS-certified vaults. Track your portfolio live and
            sell anytime with same-day bank credit.
          </Text>
        ...
        <LinearGradient colors={["#112347", "#162d57"]} style={s.section}>
          ...
          <Text style={s.sTitle}>
            Buy gold in <Text style={s.sGold}>5 simple steps</Text>
          </Text>
          <Text style={s.sDesc}>
            From live price to vault — takes just minutes.
          </Text>
        ...
        <LinearGradient colors={["#0d1f3c", "#112347"]} style={s.section}>
          ...
          <Text style={s.sTitle}>
            Everything you need to <Text style={s.sGold}>own gold</Text>
          </Text>
          <Text style={s.sDesc}>
            No locker. No worries. Buy, track and sell from your phone.
          </Text>
              ...
              <View key={f.n} style={s.featCard}>
                <View style={s.featHeader}>
                  ...
                  <View style={s.featTag}>
                    <Text style={s.featTagText}>{f.tag}</Text>
                  </View>
                </View>
        ...
        ══════════════════════════════════════ */}
        <LinearGradient
          colors={["#112347", "#0d1f3c"]}
          style={[s.section, { paddingVertical: 32 }]}
        >
        ...
        <View style={[s.section, { backgroundColor: "#f0f4ff" }]}>
          ...
          <Text style={[s.sTitle, { color: "#0d1f3c" }]}>
            ...
            <Text style={{ color: "#2a4e9e" }}>across India</Text>
          </Text>
          <FlatList
            data={TESTIMONIALS}
            horizontal
              ...
              <View style={[s.testCard, { width: width - 48 }]}>
                ...
                <View style={s.testAuthor}>
                  <View style={s.testAvatar}>
                    <Text style={s.testAvatarText}>{item.av}</Text>
                  </View>
                  <View>
        ...
        ══════════════════════════════════════ */}
        <LinearGradient
          colors={["#0d1f3c", "#112347"]}
          style={[s.section, { alignItems: "center" }]}
        >
          ...
          <Text style={s.ctaTitle}>
            Start buying <Text style={s.sGold}>Digital Gold</Text> today
          </Text>
          <Text style={s.ctaDesc}>
            From ₹100. No lock-in. No hidden fees. Sell anytime.
          </Text>
          <TouchableOpacity onPress={handleBuyGold} activeOpacity={0.85}>
            <LinearGradient colors={["#f0bb3a", "#d9a020"]} style={s.btnGold}>
              <Text style={s.btnGoldText}>Buy Digital Gold →</Text>
...
const s = StyleSheet.create({
  ...
  gridLine: {
    ...
    right: 0,
    height: 1,
    backgroundColor: "rgba(42,78,158,0.07)",
  },
  heroEyebrow: {
    fontSize: 9,
    fontWeight: "700",
    color: "rgba(240,187,58,0.6)",
    letterSpacing: 2,
  ...
  heroChip: {
    ...
    top: 10,
    right: 10,
    backgroundColor: "rgba(240,187,58,0.9)",
    paddingHorizontal: 8,
    paddingVertical: 4,
    borderRadius: 6,
  },
  ...
  mqItem: {
    ...
    borderRightWidth: 1,
    borderRightColor: "rgba(13,31,60,0.2)",
  },
  ...
  aboutImg: {
    ...
    borderRadius: CARD_R,
    borderWidth: 1.5,
    borderColor: "rgba(240,187,58,0.2)",
  },
  aboutImgFade: {
    position: "absolute",
    bottom: 0,
  ...
  aboutRow: {
    ...
    borderRadius: 10,
    borderWidth: 1,
    borderColor: "rgba(42,78,158,0.25)",
  },
  aboutIconBox: {
    width: 40,
    height: 40,
    borderRadius: 10,
    backgroundColor: "rgba(240,187,58,0.08)",
    borderWidth: 1,
    borderColor: "rgba(240,187,58,0.2)",
    alignItems: "center",
  ...
  statsGrid: {
    ...
    overflow: "hidden",
    borderWidth: 1,
    borderColor: "rgba(42,78,158,0.22)",
  },
  statItem: {
    width: (width - 50) / 2,
    backgroundColor: "#112347",
  ...
  dot: {
    ...
    height: 6,
    borderRadius: 3,
    backgroundColor: "rgba(42,78,158,0.25)",
  },
